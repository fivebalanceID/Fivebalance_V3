Contributing to FIVEBALANCE Core
============================

The FIVEBALANCE Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/fivebalance-project/fivebalance/blob/master/doc/translation_process.md)
...
The following applies to code changes to the FIVEBALANCE Core project, and is not to be
confused with overall FIVEBALANCE Network Protocol consensus changes.

Whether a pull request is merged into FIVEBALANCE Core rests with the project merge
...
Patches that change FIVEBALANCE consensus rules are considerably more involved than
...
Where a patchset proposes to change the FIVEBALANCE consensus, it must have been
...
The project leader is the release manager for each FIVEBALANCE Core release.
