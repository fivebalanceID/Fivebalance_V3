...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/fivebalance-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/fivebalance-cli.cpp \
           src/fivebalance-tx.cpp \
           src/fivebalance.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/fivebalance.qrc src/qt/fivebalance_locale.qrc

TRANSLATIONS += src/qt/locale/fivebalance_bg.ts \
                src/qt/locale/fivebalance_de.ts \
                src/qt/locale/fivebalance_en.ts \
                src/qt/locale/fivebalance_es.ts \
                src/qt/locale/fivebalance_fi.ts \
                src/qt/locale/fivebalance_fr.ts \
                src/qt/locale/fivebalance_it.ts \
                src/qt/locale/fivebalance_ja.ts \
                src/qt/locale/fivebalance_pl.ts \
                src/qt/locale/fivebalance_pt.ts \
                src/qt/locale/fivebalance_ru.ts \
                src/qt/locale/fivebalance_sk.ts \
                src/qt/locale/fivebalance_sv.ts \
                src/qt/locale/fivebalance_vi.ts \
                src/qt/locale/fivebalance_zh_CN.ts \
                src/qt/locale/fivebalance_zh_TW.ts
