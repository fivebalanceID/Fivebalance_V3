...
from test_framework.fivebalance_node import FivebalanceTestNode
...
class FIVEBALANCE_ColdStakingTest(FivebalanceTestFramework):
...
if __name__ == '__main__':
    FIVEBALANCE_ColdStakingTest().main()
