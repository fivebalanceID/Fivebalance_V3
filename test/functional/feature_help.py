...
"""Verify that starting fivebalance with -h works as expected."""
import subprocess

from test_framework.test_framework import FivebalanceTestFramework
from test_framework.util import assert_equal

class HelpTest(FivebalanceTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fivebalance with -? for help text")
        ...
        self.log.info("Start fivebalance with -version for version information")
