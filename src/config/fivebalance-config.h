/* src/config/fivebalance-config.h.  Generated from fivebalance-config.h.in by configure.  */
/* src/config/fivebalance-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.fivebalance.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Fivebalance Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Fivebalance Core 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fivebalance"
