...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 FBN at the same time
...
enum ZerocoinSpendStatus {
    ...
    ZFBN_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
...
public:
    ...
    */
    ...
    void setZFivebalanceAutoBackups(bool fEnabled)
    {
