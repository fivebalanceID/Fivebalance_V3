...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Fivebalance features */
        {"fivebalance", "masternode", &masternode, true, true, false},
        {"fivebalance", "listmasternodes", &listmasternodes, true, true, false},
        {"fivebalance", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fivebalance", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fivebalance", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fivebalance", "masternodedebug", &masternodedebug, true, true, false},
        {"fivebalance", "startmasternode", &startmasternode, true, true, false},
        {"fivebalance", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fivebalance", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fivebalance", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fivebalance", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fivebalance", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fivebalance", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fivebalance", "mnbudget", &mnbudget, true, true, false},
        {"fivebalance", "preparebudget", &preparebudget, true, true, false},
        {"fivebalance", "submitbudget", &submitbudget, true, true, false},
        {"fivebalance", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fivebalance", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fivebalance", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fivebalance", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fivebalance", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fivebalance", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fivebalance", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fivebalance", "checkbudgets", &checkbudgets, true, true, false},
        {"fivebalance", "mnsync", &mnsync, true, true, false},
        {"fivebalance", "spork", &spork, true, true, false},
        {"fivebalance", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"fivebalance", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use fivebalanced, or the -server option to fivebalance-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> fivebalance-cli " + methodname + " " + args + "\n";
}
