...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("04230591895a2a274a733989e10bd15f9cf7bfc26fcfcriki3d72d584378bd208c59f7809220154bd808b53ccbd422e864f359105f277a30026752fd404a0fc76") << OP_CHECKSIG;
...
static const Checkpoints::CCheckpointData data = {
    ...
    1261378,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1540209717, 80527, 0x1e0ffff0, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00001a572ee83b41c45a0eb5ba27ec7f90043ea6d17f91b9c17f45db59287ceb"));
        assert(genesis.hashMerkleRoot == uint256S("0x7d03457fc801eafabfccac779c7e9957637524ece947c83a5980032e5f08f52b"));
        ...
        // validation by-pass
        consensus.nFivebalanceBadBlockTime = 1557081232;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nFivebalanceBadBlockBits = 0x1e00ffff;    // Skip nBit validation of Block 259201 per PR #915
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight         = 625041;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_PUBLIC].nActivationHeight     = 99999999;
        consensus.vUpgrades[Consensus::UPGRADE_V3_4].nActivationHeight          = 626000;
        consensus.vUpgrades[Consensus::UPGRADE_V4_0].nActivationHeight          = 626000;
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "seed1.fivebalance.com", true));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.fivebalance.com", true));    // Secondary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.fivebalance.com", true));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.fivebalance.com", true));
        vSeeds.push_back(CDNSSeedData("seed5", "seed5.fivebalance.com", true));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x03)(0x88)(0xC3)(0x2E).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x03)(0x88)(0xD3)(0xE2).convert_to_container<std::vector<unsigned char> >();
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x00)(0x01)(0x5E).convert_to_container<std::vector<unsigned char> >();
...
//        assert(genesis.hashMerkleRoot == uint256S("0x1b2ef6e2f28be914103a277377ae7729dcd125dfeb8bf97bd5964ba72b6dc39b"));
        ...
        // validation by-pass
        consensus.nFivebalanceBadBlockTime = 1489001494; // Skip nBit validation of Block 201 per PR #915
        consensus.nFivebalanceBadBlockBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "fivebalance-testnet.seed.fuzzbawls.pw", true));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "fivebalance-testnet.seed2.fuzzbawls.pw", true));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet fivebalance addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet fivebalance script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet fivebalance BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet fivebalance BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet fivebalance BIP44 coin type is '1' (All coin's testnet default)
