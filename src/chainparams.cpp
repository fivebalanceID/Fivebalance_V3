...
public:
    CMainParams()
    {
        ...
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Fivebalance starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Fivebalance: 1 minute  
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04230591895a2a274a733989e10bd15f9cf7bfc26fcfcriki3d72d584378bd208c59f7809220154bd808b53ccbd422e864f359105f277a30026752fd404a0fc76") << OP_CHECKSIG;
        ...
        assert(hashGenesisBlock == uint256("0x00001a572ee83b41c45a0eb5ba27ec7f90043ea6d17f91b9c17f45db59287ceb"));
        assert(genesis.hashMerkleRoot == uint256("0x7d03457fc801eafabfccac779c7e9957637524ece947c83a5980032e5f08f52b"));


        vSeeds.push_back(CDNSSeedData("seed1", "seed1.fivebalance.com"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.fivebalance.com"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.fivebalance.com"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.fivebalance.com"));
        vSeeds.push_back(CDNSSeedData("seed5", "seed5.fivebalance.com"));
        vSeeds.push_back(CDNSSeedData("seed6", "seed6.fivebalance.com"));
        ...
        // 	BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md #350
...
{
	return "5SpMouX65SB5Ab1RjGA1TQ9dKVzPRLJrb1"; //devloper reward 0%
}
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Fivebalance: 1 minute
        nTargetSpacing = 90;  // Fivebalance: 1.5 minute
        nLastPOWBlock = 1199;
        nMaturity = 15;
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Fivebalance: 1 day
        nTargetSpacing = 90;        // Fivebalance: 1.5 minutes
