...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), FIVEBALANCE_CONF_FILENAME));
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), FIVEBALANCE_PID_FILENAME));
#endif
    ...
    strUsage += HelpMessageOpt("-mnconf=<file>", strprintf(_("Specify masternode configuration file (default: %s)"), FIVEBALANCE_MASTERNODE_CONF_FILENAME));
...
std::string LicenseInfo()
{
    return FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf(_("Copyright (C) %i The FIVEBALANCE Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
        ...
        do {
            ...
            try {
                ...
                if (fReindexMoneySupply) {
                    ...
                    RecalculateFIVEBALANCEupply(1, fReindexZerocoin);
                }
