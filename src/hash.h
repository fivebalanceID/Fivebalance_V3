...
#ifndef FIVEBALANCE_HASH_H
#define FIVEBALANCE_HASH_H
...
inline int GetHashSelection(const uint256 PrevBlockHash, int index) {
    ...
    #define STFBN_OF_LAST_16_NIBBLES_OF_HASH 48
    int hashSelection = PrevBlockHash.GetNibble(STFBN_OF_LAST_16_NIBBLES_OF_HASH + index);
