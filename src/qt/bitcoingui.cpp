                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Fivebalance Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Fivebalance address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fivebalance: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFBN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Fivebalance Core"), this);
    aboutAction->setStatusTip(tr("Show information about Fivebalance Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Fivebalance"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Fivebalance addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Fivebalance addresses"));
    ...
    openAction->setStatusTip(tr("Open a Fivebalance: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Fivebalance Core help message to get a list with possible Fivebalance command-line options"));
