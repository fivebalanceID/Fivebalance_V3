...
public:
    ...
    void setZFivebalanceControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzFBN_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzFBN_clicked();
    void on_pushButtonZFivebalanceControl_clicked();
