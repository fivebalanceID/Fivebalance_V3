...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Fivebalance address (e.g. %1)").arg("5fM4UpDanDS1qznC8PFDTXmmQcZit7pfbW"));
#endif
...
{
    // return if URI is not valid or is no Fivebalance: URI
...
void openConfigfile()
{
    ...
    /* Open fivebalance.conf with the associated application */
