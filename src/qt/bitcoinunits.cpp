...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(FBN);
    unitlist.append(mFBN);
    unitlist.append(uFBN);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case FBN:
        return QString("fivebalance");
    case mFBN:
        return QString("mfivebalance");
    case uFBN:
        return QString::fromUtf8("ufivebalance");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZfbn)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZFBN)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZFBN);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZFBN)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZFBN));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
