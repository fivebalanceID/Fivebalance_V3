...
#include "qt/fivebalance/forms/ui_receivewidget.h"
...
#include "qt/fivebalance/addressholder.h"
...
ReceiveWidget::ReceiveWidget(FIVEBALANCEGUI* parent) :
    PWidget(parent),
