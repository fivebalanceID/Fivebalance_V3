...
#include "qt/fivebalance/forms/ui_masternodeswidget.h"

#include "qt/fivebalance/qtutils.h"
#include "qt/fivebalance/mnrow.h"
#include "qt/fivebalance/mninfodialog.h"
#include "qt/fivebalance/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(FIVEBALANCEGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= (COIN * 1000000)) {
        inform(tr("Not enough balance to create a masternode, 1000000 %1 required.").arg(CURRENCY_UNIT.c_str()));
        return;
    }
    showHideOp(true);
