...
#include "qt/fivebalance/settings/settingsnetworkwidget.h"
#include "qt/fivebalance/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/fivebalance/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(FIVEBALANCEGUI* _window, QWidget *parent) :
