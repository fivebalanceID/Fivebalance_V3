...
#include "qt/fivebalance/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/fivebalance/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(FIVEBALANCEGUI* _window, QWidget *parent) :
