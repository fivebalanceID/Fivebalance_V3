...
#include "qt/fivebalance/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(FIVEBALANCEGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &FIVEBALANCEGUI::openFAQ);
