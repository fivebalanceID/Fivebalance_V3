...
#include "qt/fivebalance/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/fivebalance/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(FIVEBALANCEGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableFBN,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableFBN,
    ...
    connect(ui->pushButton_UnspendableFBN, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableFBN);});
    ...
    if (parent)
        connect(parent, &FIVEBALANCEGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
