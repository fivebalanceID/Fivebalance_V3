...
#include "qt/fivebalance/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/fivebalance/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(FIVEBALANCEGUI* _window, QWidget *parent) :
