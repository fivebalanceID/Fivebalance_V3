...
#include "qt/fivebalance/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(FIVEBALANCEGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("FIVEBALANCE_tx_csv_export(*.csv)") : tr("FIVEBALANCE_addresses_csv_export(*.csv)"),
                                        nullptr);
