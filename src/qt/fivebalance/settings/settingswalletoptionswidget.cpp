...
#include "qt/fivebalance/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/fivebalance/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(FIVEBALANCEGUI* _window, QWidget *parent) :
