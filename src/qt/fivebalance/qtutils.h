...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, FIVEBALANCEGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, FIVEBALANCEGUI* gui, double posX = 3);
