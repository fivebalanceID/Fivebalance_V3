...
#include "qt/fivebalance/furabstractlistitemdelegate.h"
#include "qt/fivebalance/txviewholder.h"
#include "qt/fivebalance/tooltipmenu.h"
#include "qt/fivebalance/sendmultirow.h"
#include "qt/fivebalance/coldstakingmodel.h"
#include "qt/fivebalance/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(FIVEBALANCEGUI* parent);
    ~ColdStakingWidget();
