...
#include "qt/fivebalance/sendcustomfeedialog.h"
#include "qt/fivebalance/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(FIVEBALANCEGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &FIVEBALANCEGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
