...
#include "qt/fivebalance/topbar.h"
#include "qt/fivebalance/forms/ui_topbar.h"
#include "qt/fivebalance/lockunlock.h"
#include "qt/fivebalance/qtutils.h"
#include "qt/fivebalance/receivedialog.h"
#include "qt/fivebalance/loadingdialog.h"
...
TopBar::TopBar(FIVEBALANCEGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopFbn}, "amount-small-topbar");
    setCssProperty({ui->labelAmountFbn}, "amount-topbar");
    setCssProperty({ui->labelPendingFbn, ui->labelImmatureFbn}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // PIV Total
    QString totalFbn = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);

    // PIV
    // Top
    ui->labelAmountTopFbn->setText(totalFbn);
    // Expanded
    ui->labelAmountFbn->setText(totalFbn);
    ui->labelPendingFbn->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance, nDisplayUnit));
    ui->labelImmatureFbn->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
