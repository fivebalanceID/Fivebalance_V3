...
#include <QWidget>
#include <QString>
#include "qt/fivebalance/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(FIVEBALANCEGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    FIVEBALANCEGUI* getWindow() { return this->window; }
