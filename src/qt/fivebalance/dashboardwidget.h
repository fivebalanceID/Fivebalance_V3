...
#include "config/fivebalance-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalFbn = 0;
    qint64 totalZfbn = 0;
    QList<qreal> valuesFbn;
    QList<qreal> valueszFbn;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(FIVEBALANCEGUI* _window);
    ~DashboardWidget();
