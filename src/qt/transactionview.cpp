                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Fivebalance from zFivebalance"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zFivebalance"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zFivebalance));
