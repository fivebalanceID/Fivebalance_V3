...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            FIVEBALANCEGUI* window = static_cast<FIVEBALANCEGUI*>(parentWidget());
...
{
    FIVEBALANCEGUI* gui = static_cast<FIVEBALANCEGUI*>(parentWidget());
...
{
    hide();
    static_cast<FIVEBALANCEGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("FIVEBALANCE will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your FBNs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
