...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Fivebalance Core fivebalance-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fivebalance-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fivebalance transaction") + "\n" +
                               "  fivebalance-tx [options] -create [commands]   " + _("Create hex-encoded fivebalance transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fivebalance transaction
