...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIVX features */
        {"fivebalance", "listmasternodes", &listmasternodes, true },
        {"fivebalance", "getmasternodecount", &getmasternodecount, true },
        {"fivebalance", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"fivebalance", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"fivebalance", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"fivebalance", "masternodecurrent", &masternodecurrent, true },
        {"fivebalance", "startmasternode", &startmasternode, true },
        {"fivebalance", "createmasternodekey", &createmasternodekey, true },
        {"fivebalance", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"fivebalance", "listmasternodeconf", &listmasternodeconf, true },
        {"fivebalance", "getmasternodestatus", &getmasternodestatus, true },
        {"fivebalance", "getmasternodewinners", &getmasternodewinners, true },
        {"fivebalance", "getmasternodescores", &getmasternodescores, true },
        {"fivebalance", "preparebudget", &preparebudget, true },
        {"fivebalance", "submitbudget", &submitbudget, true },
        {"fivebalance", "mnbudgetvote", &mnbudgetvote, true },
        {"fivebalance", "getbudgetvotes", &getbudgetvotes, true },
        {"fivebalance", "getnextsuperblock", &getnextsuperblock, true },
        {"fivebalance", "getbudgetprojection", &getbudgetprojection, true },
        {"fivebalance", "getbudgetinfo", &getbudgetinfo, true },
        {"fivebalance", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"fivebalance", "mnfinalbudget", &mnfinalbudget, true },
        {"fivebalance", "checkbudgets", &checkbudgets, true },
        {"fivebalance", "mnsync", &mnsync, true },
        {"fivebalance", "spork", &spork, true },
