...
#ifndef FIVEBALANCE_ZFBNWALLET_H
#define FIVEBALANCE_ZFBNWALLET_H
...
public:
    ...
    void GenerateDeterministicZFBN(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZFBN(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
