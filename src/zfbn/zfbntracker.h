...
#ifndef FIVEBALANCE_ZFBNTRACKER_H
#define FIVEBALANCE_ZFBNTRACKER_H
...
public:
    CzFBNTracker(CWallet* parent);
    ~CzFBNTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzFBNWallet* zFBNWallet = NULL);
