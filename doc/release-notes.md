...
Fivebalance Core version *version* is now available from:

  <https://github.com/eastcoastcrypto/Fivebalance/releases>

Please report bugs using the issue tracker at github:

  <https://github.com/eastcoastcrypto/Fivebalanceita/issues>
