...
In order to support loading of multiple wallets in fivebalance-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fivebalance.cpp.
...
Changes to fivebalance.cpp
----------------------
fivebalance.cpp is the entry point into fivebalance-qt, and as such, will require some minor modifications to provide hooks for
