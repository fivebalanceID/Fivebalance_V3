...
FIVEBALANCE Core is now available at `./src/fivebalanced`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/PIVX"

    touch "/Users/${USER}/Library/Application Support/PIVX/fivebalance.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/PIVX/fivebalance.conf"

The first time you run fivebalanced, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/fivebalanced -daemon # Starts the fivebalance daemon.
    ./src/fivebalance-cli --help # Outputs a list of command-line options.
    ./src/fivebalance-cli help # Outputs a list of RPC commands when the daemon is running.
