...
The script [extract-osx-sdk.sh](https://github.com/fivebalance-project/fivebalance/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
fivebalance/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/fivebalance-project/fivebalance/blob/master/doc/README_osx.md) for troubleshooting tips.