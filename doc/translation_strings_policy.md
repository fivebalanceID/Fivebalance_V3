...
This document provides guidelines for internationalization of the FIVEBALANCE Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `fivebalance_en.ts` remains unchanged.
