...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://github.com/FIVEBALANCE-Project/FIVEBALANCE/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://github.com/fivebalance-project/fivebalance/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/fivebalance-project/gitian.sigs.git
    git clone https://github.com/fivebalance-project/fivebalance-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/fivebalance-project/fivebalance.git
...
- Detached signatures will then be committed to the [fivebalance-detached-sigs](https://github.com/fivebalance-Project/fivebalance-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/FIVEBALANCE-Project/FIVEBALANCE/releases/new) with a link to the archived release notes.
